...
RELATED_DOCS_TEXT = "See https://github.com/cesarbruschetta/python-tomticket \
for usage examples."
COMPATIBILITY_WARNING_TEXT = "It looks like you are upgrading from \
an older version of python-tomticket. Please note that this new version \
(%s) is not backwards compatible." % (__version__)
COMPATIBILITY_WORKAROUND_TEXT = "To get rid of this error please set Tomticket.api_key."
CONFIGURATION_REQUIRED_TEXT = "You must set both Tomticket.api_key to use this client."
...
@six.add_metaclass(TomticketType)
class Tomticket(object):
    _class_register = {}
